...
- **US1 MVP (implemented)**: Load Markdown or 001-compatible JSON, review/edit
  draft structuring output, and export review artifacts or an integrated
  modified structuring review package.
...
src/
  ...
  adapters/         # Markdown draft adapter and mock runtime adapter (no external calls)
...
- **Markdown intake**: Markdown is converted by a UI-local deterministic adapter
  into draft review data. It does not run or replace the canonical 001 pipeline.
